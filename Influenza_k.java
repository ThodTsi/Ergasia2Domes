...
public class Influenza_k {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println(city[1].compareTo(city[2]));
            for (City x : city) {
                if (x != null) {
            ...
            /*
             * System.out.
             * print("Enter number of least infected cities per 50.000 citizens to be displayed: "
             * );
             * int k = in.nextInt();
    ...
    public static void readFile(String filePath, City[] c) {
        ...
        try {
            ...
            int n = 0; // metraei se poio line eimaste kai xrhsimopoietai ws deikths ston pinaka gia
                       // ayto kai -1
